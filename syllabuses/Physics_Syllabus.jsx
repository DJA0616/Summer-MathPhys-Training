...
const PARTS = [
  ...
  { title: "Momentum and Impulse", topics: [
    ...
    links: [
      { label: "Lecture · Momentum", href: "learning-guides/G9_Momentum_L01.html", kind: "guide" },
      { label: "Problem Set · Momentum", href: "learning-guides/G9_Momentum_PS01.html", kind: "probset" } ] },
  { title: "Energy", topics: [
    "Work and Power",
    ...
    links: [
      { label: "Lecture · Energy", href: "learning-guides/G9_Energy_L01.html", kind: "guide" },
      { label: "Problem Set · Energy", href: "learning-guides/G9_Energy_PS01.html", kind: "probset" } ] },
  { title: "Rotational Motion", topics: [
    ...
    "Angular Momentum" ],
    links: [
      { label: "Lecture · Rotation", href: "learning-guides/G9_Rotation_L01.html", kind: "guide" },
      { label: "Problem Set · Rotation", href: "learning-guides/G9_Rotation_PS01.html", kind: "probset" } ] },
  { title: "Uniform Circular Motion", topics: [
    ...
    "Banked Curves" ],
    links: [
      { label: "Lecture · Circular Motion", href: "learning-guides/G9_CircularMotion_L01.html", kind: "guide" },
      { label: "Problem Set · Circular Motion", href: "learning-guides/G9_CircularMotion_PS01.html", kind: "probset" } ] },
